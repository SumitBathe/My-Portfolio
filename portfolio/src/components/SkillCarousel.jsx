...
const skills = [
  ...
  ["Express.js", SiExpress, "#ffffff"],["React", SiReact, "#61DAFB"], ["MongoDB", SiMongodb, "#47A248"], ["HTML", SiHtml5, "#E34F26"], ["CSS", SiCss3, "#1572B6"], ["TypeScript", SiTypescript, "#3178C6"],
...
const SkillCarousel = () => {
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-r from-black via gray-800 to-gray-950 text-white py-10 flex flex-col justify-center items-center relative ">
      <h2 className="text-4xl font-bold mb-6 text-neon">Skill Set</h2>
      {/* <div className="w-full space-y-6 [mask-image:linear-gradient(to_left,transparent,black, to_right,transperent,black)] "> */}
